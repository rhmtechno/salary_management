...
public interface SalaryRepo extends JpaRepository<Salary, Long> {
	...
	@Query(value = "select ebt.accid as s_id,emp.emp_id,emp.emp_address,emp.salary_grade,emp.emp_mobile,emp.emp_name,ebt.acc_name,ebt.acc_type,\r\n"
			+ "ebt.accnumber,ebt.bank_branch,ebt.bank_name,ebt.curr_bal,gt.basic_amount,gt.gradename,gt.basic_amount*(gt.house_rent/100) as house_rent,gt.basic_amount*(gt.medical_allowance/100) as medical_allowance,\r\n"
